...
public class Parser {
    ...
    /**
     * метод выбирает первую строку как команду, запускает получение её параметров и
     * возвращает результирующую команду с набором параметров
     * */
    ...
    /**
     * @return - список команд, отделённых пайплайном
     */
